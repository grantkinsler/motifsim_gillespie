...
import sys
import getopt
from motifsim_gillespie_motifoutput import motifsim_motifoutput
from motifsim_gillespie_fulltrialoutput import motifsim_fulltrialoutput
from motifsim_gillespie_allstrandoutput import motifsim_allstrandoutput
from motifsim_gillespie_elongdataoutput import motifsim_elongdataoutput
...
def main(argv):
	...
	masterprefix = 'MotifSimulation_Gillespie_'

	parameterlist = [trials, max_strand_nr, maxStrandLength, numCells, numRounds, repr(motif), elong, bias]

	pop_tracker, nr_strands_per_time, elongation_tracker, time_tracker = motifsim_motifoutput(parameterlist,masterprefix,testprefix,trials,max_strand_nr,maxStrandLength,numCells,numRounds,motif,elong,bias)
